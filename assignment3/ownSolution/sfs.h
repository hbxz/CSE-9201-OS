...
struct sfs_inode {
	...
	u_int32_t sfi_doubleindirect;			/* Double Indirect block (fk) */
	u_int32_t sfi_tripleindirect;			/* Triple Indirect block (fk) */
	u_int32_t sfi_waste[125-3-SFS_NDIRECT]; /* unused space */
	u_int32_t sfi_blocks;                   /* Number of blocks (fk)*/
};
