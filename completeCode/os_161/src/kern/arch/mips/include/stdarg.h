/*
 * This file is taken from gcc's stdarg.h and va-mips.h, is probably
 * covered by the GPL, and will only work with gcc. It implements the
 * ANSI C standard header file <stdarg.h>.
 *
 * This file is made visible to userland, which also needs it.
 *
 * 
 * You almost certainly do not want to expend any effort on reading
 * this file or trying to understand how it works - among other things,
 * it exposes internals of gcc and knows a lot about icky mips issues.
 *
 * If you want to know how to use it, see the man page for "stdarg" on
 * any Unix system, or the equivalent section in just about any
 * compiler manual or book on C.
 */
...
/* Make va_list out of __va_list */
typedef __va_list va_list;


/* These macros implement ANSI stdargs for GNU C.  */
...
#define va_start(__AP, __LASTARG)					\
  (__AP = ((__va_list) __builtin_next_arg (__LASTARG)		\
...
#ifndef va_end
void va_end (__va_list);		/* Defined in libgcc.a */
#endif
...
/* Copy __va_list into another variable of this type.  */
