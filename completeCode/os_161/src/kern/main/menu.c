 ...
 * so you should have it call your assignment 2 waitpid code after
 * forking.
 *
...
#if OPT_ASST1PROBS
	kprintf("Warning: this probably won't work with an "
		"assignment 1 kernel.\n");
#endif
...
cmd_testmenu(int n, char **a)
{
	...
	kprintf("    (1) These tests will fail until you finish ASST1.\n");
	kprintf("    (4) These tests will fail until you finish ASST4.\n");
	kprintf("\n");
...
#if OPT_ASST1PROBS
	"[1a] Whalemating                    ",
	"[1b] Pizza Participation            ",
	"[1c] Harry Potter Fans              ",
#endif
